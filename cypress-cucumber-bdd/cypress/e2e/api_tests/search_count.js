// // cypress/e2e/api_tests/search_count.js
...
// Then('the response should contain {string}', (property) => {
//   cy.get('@response').then((res) => {
//     expect(res.body).to.have.property(property);
//   });
// });

// Then('ArticleCount should be {int}', (count) => {
//   cy.get('@response').then((res) => {
//     expect(res.body.ArticleCount).to.eq(count);
//   });
// });
